...
const links = [
  { href: "#", label: "NextJS" },
  { href: "/nextjs/intro-to-nextjs", label: "Intro to NextJS" },
];
...
export default function SideNavbar6() {
  ...
  return (
    <nav className="flex flex-col items-start gap-2 bg-background py-6 sm:w-56 h-screen border-r border-gray-200 pt-0">
      <Link
        href="#"
